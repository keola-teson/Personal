...
public class Delay
{
	 ...
	 * @param d1
	 */
	public Delay(char lw, String str, int delay1)
	{
		this.string = str;
		this.delay1 = delay1;
	 ...
	 * @param d1
	 */
	public Delay(char lw, String str, int delay1, int delay2, int delayInterval)
	{
		this.string = str;
		this.delay1 = delay1;
	...
	public void delayWords()
	{
		...
		try
		{
			...
			for (int i = 0; i < spaceIndexes.length; i++)
			{
				try
				{
					System.out.print(string.substring(spaceIndexes[i] + 1, spaceIndexes[i + 1]));
					TimeUnit.MILLISECONDS.sleep(delay1);
				}
				catch (Exception e)
				{
